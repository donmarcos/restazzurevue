<template>
  <ion-page>
    <ion-content class="ion-padding">
       <p/>
       <iframe 
         src='https://webchat.botframework.com/embed/BotService454704?s=3w-Z2w6NNk0.w_a-tFjE_IFpfjvNfm2sHPZV6om7dr6qdQJbEKW0_bM'  
         class="webPage"></iframe>
         <p/>
         <ion-button @click="backFn()"  expand="full">Go Back </ion-button>
